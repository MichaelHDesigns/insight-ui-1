...
describe('basic UI tests', () => {
  ...
  beforeAll(async () => {
    ...
    const insightUIContainerOptions = {
      volumes: [
        `${rootPath}/umbrucore-node:/insight/node_modules/insight-ui/umbrucore-node`,
        `${rootPath}/po:/insight/node_modules/insight-ui/po`,
        `${rootPath}/public:/insight/node_modules/insight-ui/public`,
      ],
    };
    ...
    await masterNode.umbruCore.getApi().generate(15);
  });
  ...
  describe('Home Page', () => {
    ...
    it('should be able search by block number', async () => {
      ...
      expect(blockReward).equal('500 UMBRU');
